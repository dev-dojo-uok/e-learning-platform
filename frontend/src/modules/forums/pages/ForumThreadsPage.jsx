    ...
    <div className="max-w-3xl mx-auto space-y-6">
      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium rounded-xl transition-colors shadow-sm shadow-indigo-200 flex-shrink-0"
        >
      ...
      <div className="flex items-center gap-3 flex-wrap">
        ...
        <div className="flex-1 min-w-[180px] relative">
          ...
          <input
            ...
            className="w-full text-sm border border-slate-200 rounded-xl pl-9 pr-4 py-2 focus:outline-none focus:ring-2 focus:ring-indigo-300 focus:border-indigo-300 transition-all"
          />
        </div>
      </div>
